...
function* createSaga(action) {
    let responce = yield createRecord("subcategory",action.payload)
...
function* getSaga(action) {
    let responce = yield getRecord("subcategory", action.payload)
    yield put({ type: GET_SUBCTEGORY_RED, payload: responce })
}
function* updateSaga(action) {
    let responce = yield updateRecord("subcategory", action.payload)
...
function* deleteSaga(action) {
    let responce = yield deleteRecord("subcategory", action.payload)
