...
function* createSaga(action) {
    let responce = yield call(createRecord,"cart", action.payload)
...
function* getSaga(action) {
    let responce = yield call(getRecord,"cart", action.payload)
    yield put({ type: GET_CART_RED, payload: responce })
}
function* updateSaga(action) {
    let responce = yield call(updateRecord,"cart", action.payload)
...
function* deleteSaga(action) {
    let responce = yield call(deleteRecord,"cart", action.payload)
