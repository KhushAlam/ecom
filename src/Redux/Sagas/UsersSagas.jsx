...
function* createSaga(action) {
    let responce = yield createRecord("user",action.payload)
...
function* getSaga(action) {
    let responce = yield getRecord("user", action.payload)
    yield put({ type: GET_USERS_RED, payload: responce })
}
function* updateSaga(action) {
    let responce = yield updateRecord("user", action.payload)
...
function* deleteSaga(action) {
    let responce = yield deleteRecord("user", action.payload)
