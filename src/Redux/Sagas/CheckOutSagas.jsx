...
function* createSaga(action) {
    let responce = yield createRecord("checkout",action.payload)
...
function* getSaga(action) {
    let responce = yield getRecord("checkout", action.payload)
    yield put({ type: GET_CHECKOUT_RED, payload: responce })
}
function* updateSaga(action) {
    let responce = yield updateRecord("checkout", action.payload)
...
function* deleteSaga(action) {
    let responce = yield deleteRecord("checkout", action.payload)
